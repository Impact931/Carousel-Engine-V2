...
class OpenAIService:
    ...
    def _create_content_optimization_prompt(
        ...
        return (
            ...
            f"- Each slide must have EXACTLY {lines_per_slide} lines (no more, no less)\n"
            ...
            f"Line 2 text here\n"
            f"Line 3 text here\n\n"
            f"- Continue this pattern for 4-{max_slides} slides\n"
            f"- Each line must be under 25 characters\n"
            f"- No explanations, meta-commentary, or extra text\n\n"
            
            f"EXAMPLE OUTPUT FORMAT:\n"
            f"SLIDE 1:\n"
            f"Dream homes exist\n"
            f"But can you afford it?\n"
            f"Let's find out...\n\n"
            f"SLIDE 2:\n"
            f"Pre-approval first\n"
            f"Know your range\n"
            f"Dream with confidence\n\n"
